...
ข้อกำหนดพาดหัว:
1. ต้องมีพาดหัว 3 แบบพอดี
2. แต่ละแบบต้องมี 3 บรรทัดพอดี
3. แต่ละบรรทัดสั้น กระชับ เหมาะสำหรับวางบนภาพข่าวหรือโพสต์โซเชียล
4. ทั้ง 3 แบบควรต่างมุมการนำเสนอเล็กน้อย แต่ข้อเท็จจริงต้องตรงกับต้นฉบับ
5. ห้ามใส่คำว่า "บรรทัด 1/2/3"
6. ห้ามใส่ Bullet, หมายเลข, Hashtag หรือเครื่องหมายคำพูดในพาดหัว
7. ห้ามแต่งเติมข้อมูลเพื่อให้พาดหัวดูน่าสนใจ
...
async function handleSummarize(req, info) {
  ...
  const cacheHash = await sha256Hex("structured-headline-v2|" + normalizedForCache);
